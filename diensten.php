...
<main>
    ...
    <div class="tuin-category tuin-ontwerp">
        ...
        <div class="tuin-category-text ontwerp-category">Tuinontwerp</div>
            <div class="tuin-text ontwerp-text">Een mooie tuin valt of staat bij een goed tuinontwerp. Als het op ontwerpen
                aankomt,
                maakt
    ...
    <div class="tuin-category tuin-aanleg">
        <img class="icon icon-tuinaanleg" src="assets/img/icon-tuinaanleg.png" alt="icon tuinaanleg">
        <div class="tuin-teksts">
    ...
    <div class="tuin-category tuin-onderhoud">
        ...
        <div class="tuin-teksts">
        <div class="tuin-category-text onderhoud-category">Tuinonderhoud</div>
